...
4. Read only affected capabilities and their linked terms, qualities, and
   decisions.
...
- Keep product outcomes in `intent/`; keep architecture and tasks in a change
  plan or technical documentation.
